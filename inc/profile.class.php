 ...
 *  @link      https://plugins.glpi-project.org/#/plugin/ticketmail
 *  ---------------------------------------------------------------------
 */ echo __('User rights management','ticketmail') . " " . $profil->fields["name"]; ?></th>
              </tr>
              <tr class='tab_bg_2'>
                 <td><?php
/**
 ...
 *  @link      https://plugins.glpi-project.org/#/plugin/ticketmail
 *  ---------------------------------------------------------------------
 */ echo  __('Tab display','ticketmail'); ?>:</td>
                 <td>
                <?php
/**
 * ---------------------------------------------------------------------
 ...
 *  @link      https://plugins.glpi-project.org/#/plugin/ticketmail
 *  ---------------------------------------------------------------------
 */ echo PLUGIN_TICKETMAIL_WEB_DIR . "/front/ticketmail.form.php"; ?>" >
 ...
 *  @link      https://plugins.glpi-project.org/#/plugin/ticketmail
 *  ---------------------------------------------------------------------
 */ echo __('Send ticket information by email','ticketmail'); ?></th>
                        </tr>
                        <tr class='tab_bg_1'>
                           <th><?php
/**
 ...
 *  @link      https://plugins.glpi-project.org/#/plugin/ticketmail
 *  ---------------------------------------------------------------------
 */ echo __('Hide private tasks and private followups','ticketmail'); ?></th>
 ...
 *  @link      https://plugins.glpi-project.org/#/plugin/ticketmail
 *  ---------------------------------------------------------------------
 */ echo __('Message','ticketmail'); ?> : </th>
                           <td>
                              <textarea name='body' id='ticketMailBody' rows='25' cols='100'><?php
/**
 * ---------------------------------------------------------------------
 *  ticketmail is a plugin to allows users to send ticket information by email
 *  ---------------------------------------------------------------------
 ...
 *  @link      https://plugins.glpi-project.org/#/plugin/ticketmail
 *  ---------------------------------------------------------------------
 */ echo $but_name; ?>' class='submit' value='<?php
/**
 * ---------------------------------------------------------------------
 *  ticketmail is a plugin to allows users to send ticket information by email
 *  ---------------------------------------------------------------------
 ...
 *  @link      https://plugins.glpi-project.org/#/plugin/ticketmail
 *  ---------------------------------------------------------------------
 */ echo $CFG_GLPI['root_doc']; ?>/css/tiny_mce/skins/light',
                      content_css: '<?php
/**
 * ---------------------------------------------------------------------
 *  ticketmail is a plugin to allows users to send ticket information by email
 ...
 *  @link      https://plugins.glpi-project.org/#/plugin/ticketmail
 *  ---------------------------------------------------------------------
 */ echo $CFG_GLPI['root_doc']; ?>/css/tiny_mce_custom.css'
                   });
